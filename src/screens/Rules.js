...
const RulesScreen = ({ navigation }) =>{
    ...
    //define const valueMax
    const {valueMax} = useSelector(state => state.juniper);
    ...
    return(
        <MyJuniperText>
            ...
            <Text style={Mystyles.paragr}>Le Joueur 1 choisit un nombre entre 1 et {valueMax}.{'\n'}
                À tour de rôle, chaque joueur doit choisir un nombre parmi
                les multiples ou les diviseurs du nombre choisi précédemment
                par son adversaire et inférieur à {valueMax}.
            </Text>
